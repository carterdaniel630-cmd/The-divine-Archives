...
window.CHAPTERS = {
  ...
  /* ------------------------------------------------------------------ ch43 */
  ch43: { html: `
    <p class="lead">The fullest Gnostic gospel the world possessed before Nag Hammadi &mdash; a Coptic scripture that surfaced in a London library <strong>160 years</strong> before the 1945 find. In it the risen Jesus, eleven years after the resurrection, unrolls the whole map of the heavens; a fallen aeon named <strong>Faith-Wisdom</strong> sings her way up out of Chaos; and <strong>Mary Magdalene</strong>, over Peter&rsquo;s objection, asks the sharpest questions of all.</p>

    <h2>A book that surfaced a lifetime before Nag Hammadi</h2>
    <p>In 1772 a London physician, <strong>Anthony Askew</strong>, bought from a bookseller a heavy parchment codex written in <strong>Coptic</strong> &mdash; the last stage of the Egyptian tongue. On his death it passed to his heirs, and in <strong>1785 the British Museum purchased it</strong>; it is catalogued today as <strong>MS Additional 5114</strong>, the <strong>Askew Codex</strong>. Its roughly <strong>350 leaves</strong> in the <strong>Sahidic</strong> dialect preserve the single most complete Gnostic scripture to survive the fall of the ancient Gnostic churches: the <strong>Pistis Sophia</strong>. And the date matters &mdash; when the famous jar of codices was struck at <strong>Nag Hammadi</strong> in 1945 (Chapter 17), this book had already sat in Europe for a century and a half. Long before the modern recovery of the Gnostics&rsquo; own words, this one volume, with its rougher cousin the <strong>Books of Jeu</strong> in the <strong>Bruce Codex</strong> (out of Egypt in 1769), was nearly the whole of what the world had of a Gnostic gospel <em>in the Gnostics&rsquo; own voice</em>.</p>

    <h2>The name, and the puzzle of what it is</h2>
    <p>The title is a modern convenience. The manuscript&rsquo;s own running headings call the work <strong>&ldquo;The Books of the Saviour,&rdquo;</strong> and the label <strong>Pistis Sophia</strong> &mdash; Greek for <strong>&ldquo;Faith-Wisdom&rdquo;</strong> &mdash; was lifted by early editors from the name of its tragic heroine. It is not one seamless text but a <strong>compilation</strong>: episodes repeat, the setting shifts, names vary, and the work falls into <strong>four &ldquo;books&rdquo;</strong> plainly not written at one sitting. The surviving Coptic is a <strong>translation of a lost Greek original</strong>, assembled in <strong>Egypt</strong> across the <strong>3rd&ndash;4th centuries CE</strong>, with the fourth book generally judged the <strong>oldest</strong> and most archaic layer. So the Pistis Sophia is less a single revelation than an <strong>anthology of one late Egyptian Gnostic community&rsquo;s teaching</strong>. Which school that community belonged to is genuinely uncertain &mdash; often placed loosely near the <strong>Sethian</strong> and <strong>Barbelo-Gnostic</strong> myths and the milieu of the Books of Jeu, but fitting no single system cleanly.</p>

    <h2>The frame: eleven silent years and a garment of light</h2>
    <p>The book opens on a scene the canonical gospels never give us. <strong>Eleven years after the resurrection</strong>, Jesus still sits with his disciples on the <strong>Mount of Olives</strong>, having taught them only in part. Then a <strong>blaze of light</strong> descends; he <strong>ascends into the heavens</strong> clothed in a radiant <strong>garment</strong> inscribed with the secret names and the plan of the upper worlds, throwing the rulers of every sphere into terror &mdash; and <strong>descends again</strong> to tell his disciples, at last, <em>everything</em>. This is the engine of the book&rsquo;s particular Gnosticism: salvation as <strong>knowing the topography of the heavens</strong> &mdash; the names, seals, and passwords of each region &mdash; so the rising soul can satisfy the gatekeepers and pass. The Pistis Sophia is, at bottom, a <strong>guidebook for the ascent of the soul</strong>, dressed as a conversation.</p>

    <h2>The fall and the thirteen repentances of Sophia</h2>
    <p>The long central drama gives the book its name. <strong>Pistis Sophia</strong> is an aeon who dwells in the <strong>thirteenth aeon</strong>, gazing up toward the light of the height. An arrogant power below, the <strong>Authad&#275;s</strong> (&ldquo;the Self-Willed&rdquo;), envies that light and projects a <strong>false light</strong>, a lion-faced counterfeit; Sophia, mistaking it for the true height, descends toward it. It is a trap &mdash; the powers of Authad&#275;s surround her, <strong>strip away her light</strong>, and drive her down into <strong>Chaos</strong>. From the depths she sings <strong>thirteen songs of repentance</strong>, crying up toward the light: <em>&ldquo;O Light of Lights, in whom I have had faith from the beginning, hear now my repentance.&rdquo;</em> And here the text does something remarkable: after each lament, <strong>the disciples interpret it</strong>, telling Jesus it is the word the light-power once spoke through <strong>David</strong> or <strong>Solomon</strong>, and reciting the matching <strong>Psalm</strong> or <strong>Ode of Solomon</strong>. The book thereby folds in the Psalter and <strong>five of the Odes of Solomon</strong> &mdash; and so became, for centuries, the chief surviving <strong>witness to those Odes</strong>, quoting them in Coptic long before the Syriac originals resurfaced in 1909. Jesus rescues Sophia not all at once but <strong>by stages</strong>, carrying back her stolen light until she is restored.</p>

    <h2>Mary Magdalene, and the quarrel over who may speak</h2>
    <p>The Pistis Sophia is one of the ancient world&rsquo;s most striking documents of a <strong>woman as foremost disciple</strong>. Of the dozens of questions the disciples put to Jesus, <strong>Mary Magdalene asks the great majority</strong> &mdash; more than all the men together. She interprets the repentances and presses the hardest questions, and Jesus calls her blessed, &ldquo;<strong>pure spiritual one</strong>,&rdquo; whose heart is set on the Kingdom &ldquo;more than all thy brethren.&rdquo; That prominence provokes a famous flash of conflict: <strong>Peter</strong> complains that she dominates and <strong>will not let the men speak</strong>; Mary later confesses she is <strong>afraid of Peter</strong>, &ldquo;because he threateneth me and hateth our sex.&rdquo; Jesus overrules him &mdash; <strong>whoever is filled with the spirit of light</strong> may speak, and none may prevent them. Set beside the <strong>Gospel of Mary</strong> and the <strong>Gospel of Thomas</strong>, the scene is central to the modern study of women, gender, and authority in early Christianity.</p>

    <h2>The machinery of salvation: mysteries, mercy, and rebirth</h2>
    <p>Behind the story lies an intricate and unusually generous theory of how souls are saved. Salvation comes through <strong>mysteries</strong> &mdash; rites, names, seals, and prayers granted in <strong>ascending grades</strong>; to receive a mystery is to be given the password and map for a region of the heavens. Souls <em>without</em> the mysteries are caught at death by the <strong>archons</strong>, who run a celestial customs-house, and sent back &mdash; here the text teaches an explicit <strong>reincarnation</strong>, souls poured again into bodies, bound to the <strong>wheel of Fate</strong>. One haunting image recurs: before rebirth, an archon hands the soul a <strong>cup of forgetfulness</strong>, &ldquo;and it drinketh it and <strong>forgetteth all things</strong>,&rdquo; returning to earth remembering nothing. Yet the tone is strikingly <strong>merciful</strong>: scarcely a sin the mysteries cannot dissolve, sins forgiven again and again, and even souls carried into the <strong>great dragon of the outer darkness</strong> &mdash; &ldquo;where there is neither pity nor light, but wailing and gnashing of teeth&rdquo; &mdash; not beyond rescue if the living perform the mystery for them. Terror and tenderness sit side by side.</p>

    <h2>The oldest layer: the fire on the mountain</h2>
    <p>The <strong>fourth book</strong>, reckoned the most archaic, drops the Sophia story and shows something rarer: a <strong>Gnostic rite in progress</strong>. Jesus says, &ldquo;<strong>Bring me fire and vine-branches</strong>,&rdquo; and lays out an <strong>offering</strong> &mdash; two vessels of <strong>wine</strong>, bread, water, herbs. The disciples stand behind him <strong>clothed in linen</strong>, holding &ldquo;the cipher of the name of the Father of the Treasury of the Light,&rdquo; while Jesus turns to the <strong>four corners</strong> and cries an invocation of <strong>mystical vowels</strong> &mdash; <em>&ldquo;Hear me, O Father, father of all fatherhood, boundless Light: ia&#333;, iou&#333;, ia&#333;, a&#333;i&hellip;&rdquo;</em> &mdash; asking that the disciples&rsquo; names be inscribed in the Kingdom of the Light. It is one of the very few places in ancient literature where we seem to watch a Gnostic sacrament being <em>performed</em>, not merely described.</p>

    <h2>Symbology and sacred encoding</h2>
    <p>If Gnosticism is &ldquo;the tradition of sacred encoding itself,&rdquo; the Pistis Sophia carries the principle to its extreme: <strong>the cosmos is a cipher, and salvation is knowing the code.</strong> <strong>The numbered heavens.</strong> The universe is an enumerated hierarchy &mdash; the <strong>thirteen aeons</strong>, the twelve below with their archons, the five Great Rulers of the midst, the <strong>Treasury of the Light</strong> &mdash; and to know a region is to know its <strong>number, name, and seal</strong>: theology-by-enumeration, as with the thirty aeons of Valentinus and the 365 heavens of Basilides, pressed into a soul&rsquo;s itinerary.</p>
    <p><strong>The vowels as divine names.</strong> The invocations are built of Greek vowels &mdash; <strong>IA&#332;</strong> and its permutations. In Greco-Egyptian magic the seven vowels encoded the names of the powers and the music of the spheres, and <strong>IA&#332;</strong> was a form of the divine name; here they are <strong>operative words of power</strong>, the actual keys that open the heavens. <strong>The garment of light</strong>, inscribed with the names and plan of the upper worlds, is the map of salvation worn as a robe &mdash; the ancient conviction that a <strong>written name carries the power it names</strong>. The luring <strong>lion-face</strong> is the same sign given the demiurge <strong>Yaldabaoth</strong> in Chapter 17: arrogant material power masked as the divine. And the very technique of the book &mdash; reading the <strong>Psalms</strong> and <strong>Odes</strong> as secretly about the fall and rescue of Wisdom &mdash; turns Scripture itself into an encoded prophecy of the myth.</p>

    <h2>Connections</h2>
    <p>The Pistis Sophia is the <strong>fullest surviving expression of a distinct late-Egyptian Gnosticism</strong>, near-twin to the ritual <strong>Books of Jeu</strong> of the <strong>Bruce Codex</strong>, which it names and which are thought older &mdash; together the &ldquo;Books of the Saviour&rdquo; literature, the initiation-and-ascent wing of the Gnostic world. It shares its <strong>Sophia myth</strong>, aeons, archons, and <strong>lion-faced demiurge</strong> with the Sethian and Valentinian systems of <strong>Chapter 17</strong>, but bends them toward ritual and eschatology. Its ladder of spheres, its wheel of Fate, and its passwords for the dead rhyme with the Orphic tablets and astral ascent of <strong>Chapter 15</strong> and the salvation-cults of <strong>Chapter 18</strong>; its explicit <strong>reincarnation</strong> and cup of forgetfulness recall transmigration from India (Chapters 5, 11, 20) to Plato&rsquo;s myth of Er. Its post-resurrection dialogue and prominent <strong>Mary Magdalene</strong> tie it to the argument, still live in <strong>Chapter 16</strong>, over women&rsquo;s authority in the earliest churches. And its afterlife runs straight into the modern occult revival: its first English translator, <strong>G. R. S. Mead</strong>, was a <strong>Theosophist</strong> and secretary to Madame Blavatsky (Chapter 37) &mdash; so the book has two lives, one in late-antique Egypt and one on the séance-era bookshelf, which must never be confused.</p>
    ...
    <div class="evidence">
      ...
      <div class="ev supported">
        <h4>What&rsquo;s well supported</h4>
        <ul>
          <li>The <strong>manuscript</strong>: the <strong>Askew Codex</strong> (British Library <strong>MS Add. 5114</strong>), a Coptic <strong>Sahidic</strong> parchment codex of ~350 leaves, bought by Dr. Anthony Askew c. 1772 and acquired by the British Museum in <strong>1785</strong>.</li>
          <li>The text as a <strong>compilation</strong> in four books, a <strong>Coptic translation of a lost Greek original</strong>, assembled in Egypt across the <strong>3rd&ndash;4th centuries CE</strong> (Book 4 the oldest layer); its own title &ldquo;<strong>Books of the Saviour</strong>,&rdquo; and its naming of the earlier <strong>Books of Jeu</strong>.</li>
          <li>Its <strong>content</strong>: the eleven-years frame and garment of light; Sophia&rsquo;s fall through <strong>Authad&#275;s</strong> and her <strong>thirteen repentances</strong>; the interwoven Psalms and <strong>five Odes of Solomon</strong> (of which it was long the chief witness); the saving <strong>mysteries</strong>, <strong>reincarnation</strong> and cup of forgetfulness, the punishments and dragon of the outer darkness, and the Book 4 <strong>fire-offering</strong>.</li>
          <li>The <strong>prominence of Mary Magdalene</strong> and the explicit <strong>Peter&ndash;Mary tension</strong>; and the editorial history &mdash; the 1851 <strong>Schwartze&ndash;Petermann</strong> Latin editio princeps, <strong>Carl Schmidt</strong>&rsquo;s work, and <strong>G. R. S. Mead</strong>&rsquo;s Theosophical English translation.</li>
        </ul>
      </div>
      <div class="ev unsupported">
        <h4>What&rsquo;s not supported</h4>
        <ul>
          <li>That it records the <strong>actual post-resurrection teaching of the historical Jesus</strong>. It is a 3rd&ndash;4th-century revelation-dialogue that puts new teaching in the risen Christ&rsquo;s mouth &mdash; a witness to <strong>later Gnostic belief</strong>, not to the events it narrates.</li>
          <li>The common confusion that it is a <strong>Nag Hammadi</strong> text or part of the <strong>Bruce Codex</strong>. It is neither: it was known 150+ years before Nag Hammadi, and it is the <strong>Askew</strong> Codex, while the Bruce Codex holds the separate Books of Jeu.</li>
          <li>The modern esoteric <strong>&ldquo;unveilings&rdquo;</strong> of the book (Theosophical, and later systems) as recoveries of its <em>original</em> meaning &mdash; valuable as reception history, not as evidence of what its ancient authors meant.</li>
        </ul>
      </div>
      <div class="ev open">
        <h4>What&rsquo;s genuinely open</h4>
        <ul>
          <li>The precise <strong>date, place, and sectarian identity</strong> of the community &mdash; Sethian, Barbeloite, Valentinian-adjacent, or its own school. No consensus, and the compilation may blend more than one milieu.</li>
          <li>How the <strong>&ldquo;books&rdquo; relate</strong> &mdash; how many sources were combined, and how much older Book 4 and its fire-rite are than the Sophia narrative.</li>
          <li>The exact <strong>original Greek</strong> behind the Coptic, and how the community&rsquo;s rituals were <strong>actually practiced</strong> &mdash; the fire-offering scene is precious but isolated.</li>
        </ul>
      </div>
    </div>
    ...
    <div class="sources">
      <h3>Sources</h3>
      <h4>Manuscript, date, and structure</h4>
      <ul>
        <li><a href="https://en.wikipedia.org/wiki/Askew_Codex">Askew Codex</a> and <a href="https://en.wikipedia.org/wiki/Pistis_Sophia">Pistis Sophia</a>; the <a href="https://searcharchives.bl.uk/catalog/032-002738266">British Library record for Add MS 5114</a>; the scholarly <a href="https://www.nasscal.com/e-clavis-christian-apocrypha/pistis-sophia/">NASSCAL <em>e-Clavis</em>: Pistis Sophia</a> (compilation, dating, the four books, relation to the Books of Jeu); <a href="https://biblia.com/books/lbd/word/Askew_Codex">Lexham Bible Dictionary: Askew Codex</a>.</li>
      </ul>
      <h4>The text, and the Books of Jeu</h4>
      <ul>
        <li>The primary text in <a href="https://gutenberg.org/files/76266/76266-h/76266-h.htm">G. R. S. Mead&rsquo;s public-domain translation</a> (the repentances, the mysteries, the cup of forgetfulness, the Book 4 fire-rite, the Peter&ndash;Mary exchange) and the <a href="http://www.gnosis.org/library/pistis-sophia/pistis-sophia.htm">Gnostic Society Library</a>; on the Bruce Codex, <a href="https://en.wikipedia.org/wiki/Books_of_Jeu">Books of Jeu</a>; reception history at <a href="https://www.theosophical.org/publications/quest-magazine/the-pistis-sophia-an-introduction">the Theosophical Society</a>.</li>
      </ul>

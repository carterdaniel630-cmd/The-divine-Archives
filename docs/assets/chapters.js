...
window.CHAPTERS = {
  ...
  ch21: { html: `
    ...
    <h2>The mothers of the believers</h2>
    <p>Muhammad did not stand alone, and the first Muslims included women the tradition places at the very foundation. The <strong>first believer of all</strong> &mdash; the first person, man or woman, to accept the message &mdash; was his wife <strong>Khadija</strong>, a wealthy Meccan merchant who had employed him and then proposed to him; when he came down from Hira shaking with terror, she wrapped and reassured him, and while she lived he took no other wife. His later wives bear the collective title <strong>Mothers of the Believers</strong> (<em>Ummahat al-Mu&rsquo;minin</em>, Qur&rsquo;an 33:6). Foremost, <strong>Aisha</strong>, daughter of the first caliph, became one of Islam&rsquo;s greatest <strong>transmitters of hadith</strong> (over two thousand reports traced to her) and in <strong>656</strong> led an army against Ali at the <strong>Battle of the Camel</strong>. Most consequential was Muhammad&rsquo;s daughter <strong>Fatima</strong>, who married <strong>Ali</strong> and bore <strong>Hasan and Husayn</strong>: the whole line of Shia <strong>Imams</strong> and the <strong>Fatimid</strong> dynasty descend through her. <em>An honesty note:</em> much of this detail reaches us through the later <em>sira</em> and hadith read cautiously above, and Sunni and Shia remember Aisha and Fatima very differently, each through the lens of the schism to come.</p>
    ...
    <h2>Was the Qur&rsquo;an created?</h2>
    <p>The tradition calls the Qur&rsquo;an the &ldquo;uncreated word of God&rdquo; &mdash; but that phrase was not always settled; it was fought over, in the open light of history. In the ninth-century Abbasid golden age, the rationalist <strong>Mu&rsquo;tazila</strong> theologians took up the tools of Greek logic (Chapter 15) and pressed <em>tawhid</em> to its limit: if God is absolutely one, nothing can be co-eternal beside him, so the Qur&rsquo;an, however holy, must be <strong>created</strong> in time. In <strong>833</strong> the caliph <strong>al-Ma&rsquo;mun</strong> made this the state creed and launched the <strong>Mihna</strong>, an &ldquo;inquisition&rdquo; (the word means testing, ordeal) forcing scholars and judges to profess it on pain of prison; it ran under three caliphs to about <strong>848</strong>. The traditionist <strong>Ahmad ibn Hanbal</strong> (d. 855), namesake of the fourth Sunni law-school, refused, was imprisoned and flogged, and became the hero of the resistance. The Mihna collapsed under <strong>al-Mutawakkil</strong>, and the doctrine of the <strong>uncreated Qur&rsquo;an</strong> triumphed &mdash; becoming, and remaining, Sunni orthodoxy. The lasting settlement came in <strong>kalam</strong> (dialectical theology): <strong>al-Ash&rsquo;ari</strong> (c. 874&ndash;935), himself a former Mu&rsquo;tazilite, turned the school&rsquo;s own rational method <em>against</em> it to defend traditional doctrine, and <strong>al-Maturidi</strong> (d. 944) worked a parallel synthesis in the east &mdash; their schools becoming the Sunni theological mainstream. A rare, valuable case for this archive: a doctrine the tradition now states as timeless, caught in the sources being argued into orthodoxy.</p>
    ...
    <h2>The third party: the Kharijites and the Ibadis</h2>
    <p>The Sunni&ndash;Shia split is the famous one, but the first great schism produced <strong>three</strong> parties, not two. During the first civil war, when <strong>Ali</strong> agreed to settle his conflict with his rival Mu&rsquo;awiya by human <strong>arbitration</strong> after the Battle of <strong>Siffin</strong> (657), a bloc of his own supporters seceded in outrage &mdash; to submit God&rsquo;s cause to a human tribunal was itself betrayal &mdash; and became the <strong>Kharijites</strong> (<em>Khawarij</em>, &ldquo;those who went out&rdquo;), under the slogan <em>la hukma illa lillah</em>, &ldquo;judgment belongs to God alone.&rdquo; Ali crushed them at <strong>Nahrawan</strong> (658); in revenge a Kharijite assassinated him in the mosque of Kufa in <strong>661</strong>, ending the age of the Rightly Guided caliphs. Their defining doctrine was severe &mdash; that a Muslim who commits a <strong>grave sin</strong> thereby ceases to be a Muslim &mdash; and the extreme wing, the <strong>Azariqa</strong>, pushed it into a doctrine of <strong>takfir</strong> (excommunication) whose shadow is long. But one moderate strand alone survived: the <strong>Ibadis</strong>, who reject the killing, hold a grave sinner an &ldquo;ingrate for grace&rdquo; rather than an apostate, and &mdash; unlike the Shia with their divinely appointed bloodline &mdash; choose their imam by the community&rsquo;s <strong>consensus</strong> (<em>shura</em>). Ibadi Islam is the tradition of <strong>Oman</strong> to this day; modern Ibadis generally reject the &ldquo;Kharijite&rdquo; label as an enemy&rsquo;s slur.</p>
    ...
    <div class="evidence">
      ...
      <div class="ev supported">
        ...
        <ul>
          ...
          <li>The first civil war produced a <strong>third party</strong> beyond Sunni and Shia &mdash; the <strong>Kharijites</strong>, whose one surviving moderate branch, the <strong>Ibadis</strong>, remains the tradition of <strong>Oman</strong>; and the documented <strong>Mihna</strong> (833&ndash;848), the Abbasid state&rsquo;s attempt to impose the &ldquo;created Qur&rsquo;an&rdquo; doctrine, resisted by <strong>Ahmad ibn Hanbal</strong>.</li>
        </ul>
      </div>
      <div class="ev unsupported">
        <h4>What&rsquo;s not supported (as history)</h4>
    ...
    <div class="sources">
      ...
      <h4>The founding women, the Kharijites/Ibadis, and the createdness controversy</h4>
      <ul>
        <li>On the Mothers of the Believers: <a href="https://en.wikipedia.org/wiki/Battle_of_the_Camel">Battle of the Camel</a> (Aisha, 656); <a href="https://en.wikipedia.org/wiki/Zaynab_bint_Jahsh">Zaynab bint Jahsh</a>; <a href="https://www.britannica.com/topic/Fatimid-dynasty">Britannica: Fatimid dynasty</a> (descent from Fatima); with standard overviews of Khadija as the first believer.</li>
        <li>On the third party: <a href="https://en.wikipedia.org/wiki/Kharijites">Kharijites</a>; <a href="https://en.wikipedia.org/wiki/Battle_of_Nahrawan">Battle of Nahrawan</a>; <a href="https://www.britannica.com/topic/Ibadiyyah">Britannica: Ibadiyyah</a> (moderate Kharijism, Oman, imam by <em>shura</em>).</li>
        <li>On the Mihna and kalam: <a href="https://en.wikipedia.org/wiki/Mihna">Mihna</a> (833&ndash;848); <a href="https://www.newworldencyclopedia.org/entry/Mu'tazili">New World Encyclopedia: Mu&rsquo;tazili</a> (created Qur&rsquo;an, Ahmad ibn Hanbal, al-Ash&rsquo;ari).</li>
      </ul>

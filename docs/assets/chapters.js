...
window.CHAPTERS = {
  ...
  ch21: { html: `
    ...
    <p>One episode of Muhammad&rsquo;s life became foundational far beyond biography. In the <strong>Isra and Mi&#703;raj</strong> &mdash; the Night Journey and Ascension &mdash; Muhammad is carried in a single night from Mecca to Jerusalem (the <em>Isra</em>) on a winged steed, <strong>Buraq</strong>, and there, from the rock of the Temple Mount, ascends through the <strong>seven heavens</strong> (the <em>Mi&#703;raj</em>), meeting the earlier prophets &mdash; Adam, Jesus, Moses, Abraham &mdash; heaven by heaven, and coming at last into the divine presence, where the five daily prayers are ordained. Alluded to in the Qur&rsquo;an (Sura 17 opens with the &ldquo;journey by night&rdquo;) and elaborated in the hadith, the Night Journey made <strong>Jerusalem</strong> the third holiest city of Islam and the original direction of prayer, and became, for the later mystics, the archetype of the soul&rsquo;s ascent to God. The <strong>Dome of the Rock</strong>, raised over that rock in <strong>691</strong>, is Islam&rsquo;s oldest surviving monument and the architectural memory of the ascent.</p>
    ...
    <h2>The third branch: the Kharijites and the Ibadis</h2>
    <p>The Sunni&ndash;Shia divide was not the only fracture of the first century. During Ali&rsquo;s own caliphate, when he agreed to arbitrate his dispute with the rival <strong>Mu&#703;awiya</strong>, a group of his followers turned against him in fury, holding that judgment belonged to God alone and that submitting the caliphate to human arbitration was itself a sin. These were the <strong>Kharijites</strong> (<em>Khawarij</em>, &ldquo;those who go out,&rdquo; the seceders) &mdash; a third party rejecting <em>both</em> the Sunni and Shia claims. Radically egalitarian, they held that <strong>any</strong> upright Muslim, of any birth, could lead the community, and treated grave sinners as apostates; it was a Kharijite who assassinated Ali in 661. Most Kharijite movements were violent and short-lived, but one moderate offshoot endured: the <strong>Ibadis</strong>, who survive today as the majority in <strong>Oman</strong> and in scattered communities of North and East Africa &mdash; a living <strong>third branch</strong> of Islam beside the Sunni and the Shia.</p>
    ...
    <div class="evidence">
      ...
      <div class="ev supported">
        ...
        <ul>
          ...
          <li>The <strong>third branch</strong> &mdash; the <strong>Kharijites</strong> (seceders who rejected Ali&rsquo;s arbitration) and their surviving moderate offshoot the <strong>Ibadis</strong> (majority in Oman today); and the centrality of the <strong>Night Journey</strong> (Isra and Mi&#703;raj) to Islam&rsquo;s sanctification of Jerusalem, marked by the <strong>Dome of the Rock</strong> (691).</li>
        </ul>
      </div>
      <div class="ev unsupported">
        <h4>What&rsquo;s not supported (as history)</h4>
    ...
    <div class="sources">
      ...
      <ul>
        <li><a href="https://www.khanacademy.org/humanities/ap-art-history/introduction-cultures-religions-apah/islam-apah/a/the-five-pillars-of-islam">Khan Academy: The Five Pillars of Islam</a>; the Night Journey (<a href="https://en.wikipedia.org/wiki/Isra'_and_Mi'raj">Isra&rsquo; and Mi&rsquo;raj</a>, Qur&rsquo;an 17:1) and the third branch (<a href="https://en.wikipedia.org/wiki/Ibadism">Ibadism</a>, the surviving Kharijites); on the succession, Ali, and Karbala, standard reference overviews; <a href="https://www.metmuseum.org/essays/geometric-patterns-in-islamic-art">The Met: Geometric Patterns in Islamic Art</a>; <a href="https://en.wikipedia.org/wiki/Islamic_ornament">Islamic ornament</a>.</li>
      </ul>
  ...
  ch22: { html: `
    ...
    <h2>The unknown God: Pseudo-Dionysius</h2>
    <p>Around the year 500, a Syrian monk wrote a small body of dazzling mystical treatises and signed them with the name of <strong>Dionysius the Areopagite</strong>, the Athenian whom Paul converted in Acts 17. The attribution was false (the works quote fifth-century Neoplatonism), but under the name <strong>Pseudo-Dionysius</strong> they became one of the most influential bodies of writing in Christian history. Their theme is the <strong>unknowability of God</strong>. In <em>The Mystical Theology</em>, Dionysius teaches that God is beyond every name, beyond being itself, beyond even our denials: the soul ascends by stripping away all concepts &mdash; the senses, then clear ideas, then all affirmations and negations alike &mdash; until it passes into a <strong>&ldquo;ray of divine darkness,&rdquo;</strong> where God is met not by knowing but by <em>unknowing</em>, and the truest speech about God is at last silence. This is <strong>apophatic</strong> (negative) theology, and Dionysius is its great progenitor; his companion works mapped the <strong>celestial hierarchy</strong> of nine ranks of angels. Translated into Latin in the ninth century, the corpus shaped almost every later Christian mystic, East and West &mdash; Aquinas, Eckhart, <em>The Cloud of Unknowing</em> &mdash; the fountainhead of the tradition that seeks God in the dark beyond all images and words.</p>
    ...
    <h2>The war over images</h2>
    <p>The last great doctrinal battle of the patristic East was fought over <strong>images</strong>. In <strong>726</strong> the emperor <strong>Leo III</strong> ordered the destruction of religious <strong>icons</strong>, launching more than a century of <strong>iconoclasm</strong> (&ldquo;image-breaking&rdquo;). The iconoclasts argued from the second commandment that venerating images was idolatry; their opponents, the <strong>iconodules</strong>, answered with a subtle and lasting theology of the image, whose greatest voice was <strong>John of Damascus</strong> (d. 749), writing freely under Muslim rule beyond the emperor&rsquo;s reach. It turned on two distinctions: between <strong>veneration</strong> (<em>proskynesis</em>, honor shown a holy thing, which &ldquo;passes to the prototype&rdquo;) and <strong>worship</strong> (<em>latreia</em>, due to God alone); and an <strong>incarnational</strong> argument &mdash; the God who could never be depicted has, in Christ, <strong>become visible</strong>, so to refuse to depict Christ is to deny that God truly became man. The <strong>Second Council of Nicaea (787)</strong>, the seventh and last council the whole church would share, restored the icons; after a second iconoclast wave they were reinstated for good in <strong>843</strong>, a day still kept in the Orthodox churches as the <strong>&ldquo;Triumph of Orthodoxy.&rdquo;</strong> The controversy fixed the icon at the heart of Eastern Christian worship as a <strong>window onto the holy</strong>.</p>
    ...
    <div class="evidence">
      ...
      <div class="ev supported">
        ...
        <ul>
          ...
          <li>The <strong>Dionysian corpus</strong> (c. 500, pseudonymously attributed to the Areopagite) and its <strong>apophatic</strong> theology; and the <strong>iconoclasm</strong> controversy (726&ndash;843), the <strong>Second Council of Nicaea (787)</strong> restoring the icons, and the <strong>Triumph of Orthodoxy (843)</strong>.</li>
        </ul>
      </div>
      <div class="ev unsupported">
        <h4>What&rsquo;s not supported (as history)</h4>
  ...
  ch23: { html: `
    ...
    <h2>The Norns and the web of fate</h2>
    <p>Above the gods themselves stood <strong>fate</strong>, and fate had keepers. At the root of Yggdrasil, beside the sacred <strong>Well of Ur&eth;r</strong> (the &ldquo;Well of Fate&rdquo;), dwell the three <strong>Norns</strong> &mdash; <strong>Ur&eth;r</strong> (the past), <strong>Ver&eth;andi</strong> (the present), and <strong>Skuld</strong> (the future) &mdash; who shape the destiny of every being, imagined <strong>weaving</strong> the thread of each life, measuring it, and cutting it. Ur&eth;r&rsquo;s name is the same word as the Old English <strong>wyrd</strong>, &ldquo;fate,&rdquo; and it names the deepest layer of Norse religion: destiny is woven and fixed, and even <strong>Odin marches to a doom at Ragnar&ouml;k that he foresees and cannot escape</strong>. This fatalism is the tragic grandeur of the northern myths &mdash; the gods know they will fall, and fight on regardless, and a warrior&rsquo;s glory lies not in escaping his fate but in meeting it well. (Unlike the great gods, the Norns seem to have received <strong>no cult</strong>: fate was heeded and feared, not sacrificed to.)</p>
    ...
    <h2>Elves, ancestors, and the spirits of the land</h2>
    <p>Beneath the high gods ran the religion most Norse people practised day to day: the cult of the smaller powers of home, kin, and land. The <strong>&aacute;lfar</strong> (elves) were revered beings often identified with the <strong>dead in their burial mounds</strong>, honored at a private household sacrifice called the <strong>&aacute;lfabl&oacute;t</strong> &mdash; so private that in one saga episode a traveller is turned away from door after door because the &aacute;lfabl&oacute;t is being held inside and strangers are unwelcome. The <strong>d&iacute;sir</strong> were female ancestral and protective spirits who watched over a family and its fortunes, worshipped at the <strong>disabl&oacute;t</strong>; the personal fetch-spirit, the <strong>fylgja</strong>, belongs to the same female-spirit world. And the land itself was alive with <strong>landv&aelig;ttir</strong>, the &ldquo;land-wights&rdquo; whose goodwill a farm depended on &mdash; so real to the Norse that early <strong>Icelandic law required a ship to remove its snarling dragon-head prow before nearing the coast</strong>, lest it frighten the land-spirits away. This everyday devotion to elves, ancestors, and the spirits of field and stone was the living tissue of Norse religion, closer to most people than Odin&rsquo;s Valhalla, and the part that survived longest, folded into folklore, after the great gods were gone.</p>
    ...
    <div class="evidence">
      ...
      <div class="ev supported">
        ...
        <ul>
          ...
          <li>The wide use of <strong>Mj&ouml;lnir amulets</strong>, rising in the conversion era; the centrality of <strong>fate</strong> (the Norns at the Well of Ur&eth;r; <em>wyrd</em>) and the everyday <strong>folk cult</strong> of the <strong>&aacute;lfar</strong> (elves), the <strong>d&iacute;sir</strong> (the <em>&aacute;lfabl&oacute;t</em> and <em>disabl&oacute;t</em>), and the <strong>landv&aelig;ttir</strong>; and the <strong>legal conversion of Iceland around 1000</strong>, recorded in the sagas.</li>
        </ul>
      </div>
      <div class="ev unsupported">
        <h4>What&rsquo;s not supported (as history)</h4>
    ...
    <div class="sources">
      ...
      <ul>
        ...
        <li><a href="https://en.wikipedia.org/wiki/Christianization_of_Iceland">Christianization of Iceland (c. 1000): &THORN;orgeir, the Al&thorn;ingi, &ldquo;one law and one religion&rdquo;</a>. The Norns and <em>wyrd</em> (<a href="https://norse-mythology.org/gods-and-creatures/others/the-norns/">Norse Mythology for Smart People</a>); the &aacute;lfar, d&iacute;sir, and landv&aelig;ttir folk cult (<a href="https://www.encyclopedia.com/environment/encyclopedias-almanacs-transcripts-and-maps/alfar">Encyclopedia.com: &Aacute;lfar</a>).</li>
      </ul>
  ...
  ch24: { html: `
    ...
    <p>&Sacute;&#257;kta Tantra gave the Goddess a distinctive systematic form: the <strong>Da&sacute;a Mah&#257;vidy&#257;</strong>, the &ldquo;Ten Great Wisdoms&rdquo; &mdash; ten goddesses, at once forms of the one Great Goddess and stages of tantric insight, many deliberately <strong>macabre</strong>. They begin with <strong>K&#257;l&#299;</strong> and <strong>T&#257;r&#257;</strong> and include the beautiful <strong>Tripurasundar&#299;</strong>, but they also hold figures unlike anything in gentler devotion. <strong>Chinnamast&#257;</strong> stands <strong>holding her own severed head</strong>, three jets of blood from her neck feeding her two attendants and her own drinking mouth &mdash; an image of the ego&rsquo;s self-sacrifice and of consciousness continuing beyond the silenced mind. <strong>Dh&#363;m&#257;vat&#299;</strong> is the <strong>widow-goddess</strong>, old, smoke-clad, joyless, riding a crow: the divine as absence, void, and loss. The Mah&#257;vidy&#257;s encode a characteristically tantric conviction &mdash; that the terrible, the impure, and the fearful are not outside the sacred but faces of it, and that the way to the Goddess runs through what ordinary piety flees.</p>

    <h2>The alchemical body: the Naths and the quest for immortality</h2>
    <p>One tantric current pursued not only liberation but a <strong>deathless body</strong>. The <strong>N&#257;th siddhas</strong> &mdash; a &Sacute;aiva order traced to <strong>Matsyendran&#257;th</strong> and his disciple <strong>Gorakhn&#257;th</strong> (late ninth century) &mdash; and the <strong>Rasa Siddhas</strong>, the tantric <strong>alchemists</strong>, shared one audacious goal: to perfect and immortalize the physical body itself. Their master substance was <strong>rasa</strong>, a word meaning at once <strong>mercury</strong>, the sacred essence, and the vital fluid of &Sacute;iva &mdash; and mercury, purified and reborn in the alchemist&rsquo;s fire, was thought able to transmute base metals into gold and the mortal body into a deathless one. These adepts came to read the outer laboratory work <strong>inward</strong>: the transmutation of mercury and sulphur became the inner union of &Sacute;iva and &Sacute;akti, semen and breath, drawn up the subtle body and sealed within. Out of this fusion of alchemy, subtle-body yoga, and the drive for a perfected body (<em>k&#257;ya-s&#257;dhana</em>) the N&#257;ths systematized <strong>ha&#7789;ha yoga</strong> &mdash; the &ldquo;yoga of force,&rdquo; with its postures, breath-control, locks, and seals aimed at halting time in the body. The global yoga of the modern studio descends, distantly and much transformed, from these medieval alchemists who sought to cheat death. (The classic study is David Gordon White&rsquo;s <em>The Alchemical Body</em>.)</p>
    ...
    <div class="evidence">
      ...
      <div class="ev supported">
        ...
        <ul>
          ...
          <li>The rise of <strong>Vajray&#257;na</strong> and its transmission to <strong>Tibet</strong> across these centuries; the <strong>N&#257;th siddhas</strong> and <strong>Rasa Siddhas</strong>, their fusion of mercurial alchemy and subtle-body yoga in the quest for a perfected body and their role in the formation of <strong>ha&#7789;ha yoga</strong>; the <strong>Da&sacute;a Mah&#257;vidy&#257;</strong> (the ten &Sacute;&#257;kta wisdom-goddesses); and the core technology of <strong>mantra, yantra, mandala, initiation, and the subtle-body model</strong>.</li>
        </ul>
      </div>
      <div class="ev unsupported">
    ...
    <div class="sources">
      ...
      <ul>
        ...
        <li><a href="https://en.wikipedia.org/wiki/Vajrayana">Vajray&#257;na: mah&#257;siddhas, Guhyasam&#257;ja/Cakrasa&#7747;vara/Hevajra, Padmasambhava (747), second diffusion to Tibet</a>; <a href="https://en.wikipedia.org/wiki/Chausath_Yogini_Temple,_Khajuraho">Chausath Yogini Temple, Khajuraho (c. 885); the yogin&#299; temples</a>. The N&#257;th siddhas, rasa alchemy, and the roots of ha&#7789;ha yoga (David Gordon White, <em>The Alchemical Body</em>; <a href="https://en.wikipedia.org/wiki/Nath">Nath</a>); the ten <a href="https://en.wikipedia.org/wiki/Mahavidya">Mah&#257;vidy&#257;</a>.</li>
      </ul>
  ...
  ch25: { html: `
    ...
    <h2>The angry dead: goryō and the god Tenjin</h2>
    <p>Death was the deepest pollution, and the dead could be dangerous &mdash; none more so than those who died with a grievance. In the <strong>Heian period</strong> a widespread fear arose of the <strong>gory&#333;</strong>, the vengeful spirits (<em>onry&#333;</em>) of people who had suffered unjust deaths and now struck back at the living with <strong>plagues, storms, and disaster</strong>. The remedy was as striking as the fear: rather than exorcise such a spirit, one <strong>placated and deified it</strong>, turning a feared ghost into a protective god. The classic case is <strong>Sugawara no Michizane</strong> (845&ndash;903), a brilliant scholar and minister brought down by rivals&rsquo; slander and exiled to die far from the capital. After his death, a run of calamities in Kyoto &mdash; the deaths of his enemies, epidemics, and above all <strong>lightning striking the imperial palace</strong> &mdash; was blamed on his furious spirit. The terrified court <strong>exonerated him, restored his rank, and enshrined him as a god</strong>: <strong>Tenjin</strong>, worshipped at the great <strong>Kitano</strong> and <strong>Dazaifu Tenmang&#363;</strong> shrines, where over time the vengeful ghost mellowed into a benevolent <strong>patron of scholarship</strong>, prayed to by students to this day. It is one of the most revealing patterns in Japanese religion &mdash; the sacred generated not only from awe but from <strong>fear appeased</strong>, the angry dead transformed into a kami by worship.</p>
    ...
    <h2>The mountain way: Shugendō</h2>
    <p>The fusion of kami and buddhas produced, in the mountains, a distinct tradition of its own. <strong>Shugend&#333;</strong> &mdash; &ldquo;the way of trial and power&rdquo; &mdash; grew from Japan&rsquo;s ancient reverence for <strong>mountains</strong> as sacred realms where the dead and the gods dwell, and fused it with <strong>esoteric Buddhism</strong> (Shingon and Tendai), <strong>Daoism</strong>, and shamanism into a path of ascetic power. Its legendary founder is <strong>En no Gy&#333;ja</strong> (&ldquo;En the Ascetic,&rdquo; 7th century), a mountain wizard of many miracles. Its practitioners, the <strong>yamabushi</strong> (&ldquo;those who lie down in the mountains&rdquo;), sought spiritual power through severe austerities in the peaks &mdash; fasting, standing under freezing <strong>waterfalls</strong>, chanting sutras and mantras, and traversing sacred ranges like <strong>Yoshino</strong> and <strong>&#332;mine</strong> as a ritual re-enactment of death and rebirth. Part priest, part shaman, part wonder-worker, the yamabushi served villages as healers, exorcists, and diviners, and became one of the most characteristic religious figures of medieval Japan &mdash; the living embodiment of the kami-and-buddha fusion, worked out not in a temple&rsquo;s texts but on the body, in the mountains.</p>
    ...
    <div class="evidence">
      ...
      <div class="ev supported">
        ...
        <ul>
          ...
          <li>The <strong>gory&#333;</strong> cult of pacifying vengeful spirits by deification (Sugawara no Michizane enshrined as <strong>Tenjin</strong>), and <strong>Shugend&#333;</strong>, the syncretic mountain asceticism of the <strong>yamabushi</strong>.</li>
        </ul>
      </div>
      <div class="ev unsupported">
        <h4>What&rsquo;s not supported (as history)</h4>
    ...
    <div class="sources">
      ...
      <ul>
        ...
        <li><a href="https://www.newworldencyclopedia.org/entry/Shinbutsu_shugo">Shinbutsu-sh&#363;g&#333; and jing&#363;-ji</a>; <a href="https://en.wikipedia.org/wiki/Honji_suijaku">honji suijaku; Ry&#333;bu and Sann&#333; Shint&#333;</a>. The gory&#333; cult and Sugawara no Michizane / Tenjin (<a href="https://en.wikipedia.org/wiki/Sugawara_no_Michizane">Wikipedia</a>); Shugend&#333; and the <a href="https://en.wikipedia.org/wiki/Yamabushi">yamabushi</a>.</li>
      </ul>
  ...
  ch26: { html: `
    ...
    <h2>The exile of the Shekhinah and the divine marriage</h2>
    <p>The lowest sefirah, <strong>Malkhut</strong>, has another name &mdash; the <strong>Shekhinah</strong>, the indwelling Presence of God &mdash; and around her the Zohar built one of Kabbalah&rsquo;s most daring ideas: that the divine has a <strong>feminine</strong> aspect, and that she is in <strong>exile</strong>. The Shekhinah is God turned toward creation, receptive and immanent, the &ldquo;<strong>bride</strong>&rdquo;; and because of human sin she has been <strong>separated from her divine partner</strong>, the masculine <strong>Tiferet</strong>, and cast out to wander with her people &mdash; the exile of Israel and the exile of the Shekhinah are one and the same wound. From this comes the erotic theosophy at the heart of the Zohar: the goal of religious life is to <strong>reunite the divine couple</strong> &mdash; the sacred marriage the Zohar calls <em>zivuga qaddisha</em>, &ldquo;the holy union&rdquo; &mdash; so that the light may flow freely again from the hidden God into the world. Every commandment rightly performed, every prayer offered with true intention, helps <strong>heal the rift within God himself</strong> and bring the Bride home to her Beloved &mdash; a feminine divine presence, an exiled Bride, and a God whose own inner harmony human beings are called to restore.</p>
    ...
    <h2>The German Pietists and the golem</h2>
    <p>A third medieval current ran not in Spain but in the Rhineland. The <strong>Hasidei Ashkenaz</strong>, the German-Jewish <strong>Pietists</strong> of the twelfth and thirteenth centuries &mdash; above all <strong>Judah he-Hasid</strong> and <strong>Eleazar of Worms</strong> (c. 1176&ndash;1238) &mdash; developed their own mysticism of penitence, the divine <strong>Glory</strong> (<em>kavod</em>), and the <strong>creative power of the letters</strong>. Taking the letter-cosmology of the <em>Sefer Yetzirah</em> at its literal word &mdash; that God made the world by combining letters &mdash; they worked out techniques to do the same in miniature: to fashion a <strong>golem</strong>, an artificial man, from virgin clay dug where no one had dug, and to animate it by reciting, in exact sequence, the permutations of the Hebrew alphabet (the &ldquo;<strong>231 gates</strong>&rdquo;) together with the letters of the divine Name, limb by limb, each letter answering to a part of the body. The golem &mdash; a creature made by man wielding the same letter-magic by which God made Adam &mdash; is Kabbalah&rsquo;s letter theology taken to its literal extreme, centuries before the famous later legend of the golem of Prague.</p>
    ...
    <div class="evidence">
      ...
      <div class="ev supported">
        ...
        <ul>
          ...
          <li>The Zoharic theology of the <strong>Shekhinah</strong> as the feminine, exiled divine presence and the sacred marriage (<em>zivuga qaddisha</em>); and the parallel <strong>Hasidei Ashkenaz</strong> (Judah he-Hasid, Eleazar of Worms) with their <strong>golem</strong> letter-magic.</li>
    ...
    <div class="sources">
      ...
      <ul>
        ...
        <li><a href="https://en.wikipedia.org/wiki/Notarikon">Notarikon</a>, <a href="https://en.wikipedia.org/wiki/Temurah_(Kabbalah)">Temurah</a>, and <a href="https://www.encyclopedia.com/philosophy-and-religion/bible/bible-general/gematria">Gematria</a> as documented techniques. The <a href="https://www.encyclopedia.com/social-sciences/encyclopedias-almanacs-transcripts-and-maps/shekhinah-gods-bride">Shekhinah as God&rsquo;s Bride</a> and the divine marriage; the Hasidei Ashkenaz and the <a href="https://en.wikipedia.org/wiki/Golem">golem</a> (Eleazar of Worms; Sefer Yetzirah letter-permutation).</li>
      </ul>
  ...
  ch27: { html: `
    ...
    <h2>&ldquo;I am the Truth&rdquo;: the martyr al-Hallaj</h2>
    <p>As Sufism deepened, it split over a dangerous question: what happens to a mystic who reaches <strong>fana</strong>, the annihilation of the self? The <strong>&ldquo;sober&rdquo;</strong> path of <strong>al-Junayd</strong> of Baghdad (d. 910) taught that the mystic, after annihilation, is returned to the world in his sober self, able to live within the Law. The <strong>&ldquo;intoxicated&rdquo;</strong> path, associated with the Persian <strong>Bayazid Bistami</strong> (d. 874), embraced the ecstasy itself &mdash; and out of it came the <strong>shathiyat</strong>, the &ldquo;ecstatic utterances,&rdquo; speech that bursts from a saint so effaced in God that he no longer hears his own voice (Bistami: &ldquo;Glory be to me! How great is my majesty!&rdquo;). The most famous and most fatal was spoken by <strong>Mansur al-Hallaj</strong> (c. 858&ndash;922): in union he cried <strong>&ldquo;Ana al-Haqq&rdquo;</strong> &mdash; &ldquo;<strong>I am the Truth</strong>&rdquo; &mdash; and since <em>al-Haqq</em> is one of the ninety-nine names of God, it sounded like a man calling himself God. To the Sufis it was the purest confession of <em>fana</em>: no Hallaj left to speak, only God speaking through an emptied vessel. To Baghdad it was blasphemy, and in <strong>922</strong> he was scourged, mutilated, hanged, beheaded, and burned, his ashes cast into the Tigris &mdash; laughing, the tradition says, as he died. He became Sufism&rsquo;s paradigmatic <strong>martyr of love</strong>, and his cry the eternal test-case of the razor&rsquo;s edge between blasphemy and the deepest union.</p>
    ...
    <h2>The friends of God: saints, shrines, and barakah</h2>
    <p>For most Muslims across the centuries, Sufism was met not in books of metaphysics but at a <strong>tomb</strong>. The great masters were revered as <strong>awliya Allah</strong>, the &ldquo;<strong>friends of God</strong>&rdquo; &mdash; the Qur&rsquo;anic phrase for the saints &mdash; men and women through whom flowed <strong>barakah</strong>, a spiritual blessing-power that begins in God and passes through those closest to him. Barakah could be transmitted by touch, lineage, and proximity, and above all it lingered at a saint&rsquo;s <strong>grave</strong>. So Sufi Islam became a landscape of <strong>shrines</strong> &mdash; the <em>dargah</em> of the Indian subcontinent, the <em>zawiya</em> and <em>marabout</em> tombs of North Africa &mdash; to which the faithful came in their millions, seeking healing, children, forgiveness, and the saint&rsquo;s <strong>intercession</strong> with God. They tied threads, left flowers and sweets (shared afterward as <em>tabarruk</em>, &ldquo;blessed&rdquo; food), and gathered each year for the <strong>urs</strong>, the &ldquo;wedding&rdquo; &mdash; the saint&rsquo;s death-anniversary, celebrating his final union with the Beloved. This was the lived, popular religion of much of the Muslim world for a thousand years &mdash; and exactly what the puritanical reform movements would later condemn as idolatry.</p>
    ...
    <div class="evidence">
      ...
      <div class="ev supported">
        ...
        <ul>
          ...
          <li>The core practices of <strong>dhikr</strong>, <strong>sama</strong>, and the master&ndash;disciple path; the &ldquo;sober&rdquo; vs. &ldquo;intoxicated&rdquo; schools (al-Junayd, Bayazid Bistami), the <strong>shathiyat</strong>, and the execution of <strong>al-Hallaj</strong> (922) for &ldquo;Ana al-Haqq&rdquo;; and the vast lived cult of the <strong>saints</strong> (<em>awliya</em>), their <strong>barakah</strong>, and their <strong>shrines</strong> with the <em>urs</em> festivals.</li>
        </ul>
      </div>
      <div class="ev unsupported">
        <h4>What&rsquo;s not supported (as history)</h4>
    ...
    <div class="sources">
      ...
      <ul>
        ...
        <li><a href="https://www.nimatullahi.org/sufi-symbolism">Sufi symbolism (wine, tavern, the Beloved)</a>; <a href="https://en.wikipedia.org/wiki/Anti-Sufism">the Salafi/Wahhabi condemnation of tomb-veneration and dhikr as bid&rsquo;a</a>; al-Hallaj and &ldquo;Ana al-Haqq&rdquo; (<a href="https://www.iranicaonline.org/articles/anal-haqq-i-am-the-truth-the-most-famous-of-the-sufi-sathiyat-ecstatic-utterances-or-paradoxes/">Encyclopaedia Iranica</a>); the saints, <a href="https://en.wikipedia.org/wiki/Barakah">barakah</a>, the <a href="https://en.wikipedia.org/wiki/Dargah">dargah</a>, and the <a href="https://en.wikipedia.org/wiki/Urs_(Sufism)">urs</a>; <a href="https://www.dar-al-masnavi.org/western_views.html">the de-Islamized Western reception of Rumi</a>.</li>
      </ul>
  ...
  ch28: { html: `
    ...
    <h2>The philosophers of Islam, and the &ldquo;double truth&rdquo;</h2>
    <p>The Muslim thinkers who carried Aristotle into Europe were not mere couriers; they were philosophers of the first rank whose arguments the schoolmen had to answer. <strong>Avicenna</strong> (Ibn Sina, 980&ndash;1037) built the age&rsquo;s most influential proof of God &mdash; the argument from contingency later called the <em>Proof of the Truthful</em>: everything that exists is either <strong>necessary</strong> (unable not to exist) or <strong>contingent</strong> (able not to exist), and the whole chain of contingent things must rest on a being that exists necessarily and of itself, the <em>Necessary Existent</em>. Aquinas&rsquo;s Third Way is its direct descendant. <strong>Averroes</strong> (Ibn Rushd, 1126&ndash;1198), the supreme commentator on Aristotle, defended the <strong>autonomy of philosophy</strong> &mdash; that rational inquiry has its own domain and its own right to reach conclusions &mdash; while holding that religion expresses the same truths symbolically for those who cannot follow the demonstrations. In the Latin universities his followers, above all <strong>Siger of Brabant</strong> and <strong>Boethius of Dacia</strong>, pressed this so hard that their opponents accused them of a <strong>&ldquo;double truth&rdquo;</strong>: that a thing could be true in philosophy and its opposite true in faith. Almost certainly neither Averroes nor the Latin Averroists held so crude a doctrine &mdash; the charge was their enemies&rsquo; caricature &mdash; but it was among the alarms that provoked the <strong>Condemnations of 1277</strong>, and it names the deepest fault line under the whole scholastic project: whether reason, once given its head, can be kept in harness with revelation at all.</p>

    <h2>The mystics&rsquo; counter-current</h2>
    <p>Against the Latin, syllogistic confidence of the schools ran a second current that reached God not by argument but by love and unknowing &mdash; and it often spoke in the vernacular, and often in women&rsquo;s voices. The <strong>Beguines</strong>, laywomen living in religious community outside the convent and denied any university training, produced a <strong>vernacular theology</strong> of striking daring: <strong>Hadewijch of Brabant</strong> and <strong>Mechthild of Magdeburg</strong> wrote of the soul&rsquo;s fierce love-union with God in Dutch and German, and <strong>Marguerite Porete</strong> set down <em>The Mirror of Simple Souls</em>, on the soul annihilated in divine love &mdash; for which she was condemned and <strong>burned at the stake in Paris in 1310</strong>. The Dominican master <strong>Meister Eckhart</strong> (c.&nbsp;1260&ndash;1328), himself a Paris-trained schoolman, drew on these mystics and translated the abstractions of high scholasticism into the inner drama of the soul&rsquo;s union with the divine &ldquo;<strong>ground</strong>,&rdquo; preaching in German to ordinary people; some of his propositions were condemned in 1329, the year after his death. The relationship was less pure opposition than a charged conversation: the same age that built the <em>Summa</em> also insisted, through its mystics, that the God at the end of every proof is finally met in silence &mdash; the very lesson Aquinas confessed with his &ldquo;straw.&rdquo;</p>
    ...
    <div class="evidence">
      ...
      <div class="ev supported">
        ...
        <ul>
          ...
          <li>The philosophy of <strong>Avicenna</strong> (the <em>Proof of the Truthful</em>) and <strong>Averroes</strong>, the Latin Averroists (<strong>Siger of Brabant</strong>, <strong>Boethius of Dacia</strong>), and the mystical counter-current &mdash; the <strong>Beguines</strong> (<strong>Hadewijch</strong>, <strong>Mechthild of Magdeburg</strong>, <strong>Marguerite Porete</strong>, burned 1310) and <strong>Meister Eckhart</strong>.</li>
        </ul>
      </div>
      <div class="ev unsupported">
        <h4>What&rsquo;s not supported (as history)</h4>
  ...
  ch29: { html: `
    ...
    <h2>The ballgame: the court between the worlds</h2>
    <p>Across Mesoamerica, from the Maya cities to Aztec Tenochtitlan, ran a ritual older than either: the <strong>ballgame</strong> (Maya <em>pitz</em>, Aztec <em>&#333;llamaliztli</em>), played for at least three thousand years on great I-shaped stone courts with a heavy rubber ball driven by the hips. It was sport, but never only sport. The bouncing rubber ball was read as the <strong>sun</strong>, and the walled court as the seam between the earth and the underworld, so that the game re-enacted the cosmic contest at the heart of the <strong>Popol Vuh</strong> &mdash; the <strong>Hero Twins</strong>, Hunahpu and Xbalanque, playing ball against the lords of death in <strong>Xibalba</strong> and defeating them, to be reborn as sun and moon. To play was to perform that struggle of light against darkness, life against death, and so to keep the cosmos in motion. And the game could end in <strong>sacrifice</strong>: reliefs at Chich&eacute;n Itz&aacute; and El Taj&iacute;n show a decapitated player, and in some rites the losers &mdash; or, some evidence suggests, the winners &mdash; were offered to the gods, their blood feeding the same cosmic order the game itself sustained.</p>
    ...
    <h2>The gods that would not die</h2>
    <p>The conquest shattered the temples, but it did not simply erase the religions beneath them. In the Andes in the <strong>1560s</strong>, a generation after the fall, a movement called <strong>Taki Onqoy</strong> (&ldquo;dancing sickness&rdquo;) swept the highlands: its preachers taught that the <strong>huacas</strong> &mdash; the old sacred powers, led by Pachacamac and Titicaca &mdash; were rising, entering the bodies of the faithful, and massing to defeat the Christian God and drown the Spaniards in the returning sea, restoring the Andean world. It was crushed, yet the archaeology of its centers shows something subtler than defiance: the same people were buried in Christian churches <em>and</em> kept the old rites &mdash; <strong>entangled</strong> in both religions at once, not simply choosing one. That entanglement is the real story of survival across the Americas. In Mexico the veneration of the <strong>Virgin of Guadalupe</strong>, appearing in 1531 on the hill of Tepeyac where a mother-goddess had been honored, gathered indigenous devotion into a Christian form; the offerings to <strong>Pachamama</strong> and the festivals of the dead did not vanish but wove themselves into the calendar of the Church. The temple religions were broken as institutions, but their substance survived &mdash; hidden, blended, and alive &mdash; in the folk Catholicism of Latin America to this day.</p>
    ...
    <div class="evidence">
      ...
      <div class="ev supported">
        ...
        <ul>
          ...
          <li>The <strong>Mesoamerican ballgame</strong> and its stone courts, its link to the Popol Vuh Hero Twins, and its ties to sacrifice; and the post-conquest <strong>survival</strong> of these religions &mdash; the <strong>Taki Onqoy</strong> movement of the 1560s and the syncretic devotion (the Virgin of Guadalupe, continued Pachamama offerings) that carried the old substance into folk Catholicism.</li>
        </ul>
      </div>
      <div class="ev unsupported">
  ...
  ch30: { html: `
    ...
    <h2>The love of Radha: Jayadeva&rsquo;s <em>Gita Govinda</em></h2>
    <p>If Bhakti had a single supreme song of divine love, it was composed in this very era. Around 1190, the Bengali poet <strong>Jayadeva</strong> wrote the <strong>Gita Govinda</strong> (&ldquo;Song of Govinda&rdquo;), a Sanskrit lyric cycle of twelve cantos and twenty-four <em>ashtapadis</em> &mdash; songs meant to be sung and danced &mdash; on the springtime love of <strong>Krishna</strong> and the cowherd <strong>Radha</strong>: their longing, their jealousy, their separation, and their rapturous union. It is unashamedly <strong>erotic</strong>, and that is the theology: the anguish of the lovers apart (<em>vipralambha</em>) and the ecstasy of their meeting become the very image of the soul&rsquo;s separation from and reunion with God. From it flowered the exalted mood the tradition calls <strong>madhurya bhava</strong> &mdash; loving God as the beloved, the &ldquo;sweet&rdquo; and most intimate of all devotional relationships &mdash; and with it the raising of <strong>Radha</strong> into the supreme devotee, the human heart&rsquo;s own stand-in before the divine. The <em>Gita Govinda</em> passed into temple liturgy and classical dance across India and became, in the next era, the fountainhead of Chaitanya&rsquo;s ecstatic Bengali Krishna-devotion.</p>
    ...
    <h2>The women who sang</h2>
    <p>No feature of Bhakti is more striking than the number of its greatest voices who were <strong>women</strong> &mdash; and how radically their devotion defied the world that bound them. In a society that offered a woman marriage and the household as her whole horizon, love of God became a door out of it. The Tamil <strong>Andal</strong> refused every earthly husband, declaring herself the bride of Vishnu alone. The Kannada <strong>Akka Mahadevi</strong> walked out of her marriage and wandered clothed only in her own long hair, holding Shiva her only lord. <strong>Lal Ded</strong> of Kashmir left her home and roamed unclothed, singing her <em>vakhs</em>. The Rajput princess <strong>Mirabai</strong> abandoned her royal husband&rsquo;s palace to dance and sing for Krishna, enduring exile and, in legend, poison sent by her scandalized in-laws. To choose God as husband or lover was to slip the authority of father and husband and caste at once &mdash; which is why the women saints were watched, doubted, and punished more harshly than the men, and why their songs still read as some of the boldest claims to a woman&rsquo;s own soul in the pre-modern world.</p>
    ...
    <div class="evidence">
      ...
      <div class="ev supported">
        ...
        <ul>
          ...
          <li><strong>Jayadeva</strong>&rsquo;s <em>Gita Govinda</em> (c.&nbsp;1190) and its erotic Radha-Krishna theology (<em>madhurya bhava</em>); and the prominence of <strong>women saints</strong> &mdash; Andal, Akka Mahadevi, Lal Ded, Mirabai &mdash; and their documented defiance of marriage and caste.</li>
        </ul>
      </div>
      <div class="ev unsupported">

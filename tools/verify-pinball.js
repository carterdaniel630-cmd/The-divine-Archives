#!/usr/bin/env node
/* Verify every The Firmament (Pinball) fact is grounded in real chapter text:
...
const bank=JSON.parse(fs.readFileSync(path.join(ROOT,"docs/assets/games/data/pinball.json"),"utf8"));
let fails=0,ok=0;
...
console.log("The Firmament (Pinball) facts: "+bank.facts.length+" | verified: "+ok+" | failures: "+fails);
if(fails){process.exit(1);}
console.log("VERIFY OK — every cosmos-fact is grounded in real chapter text.");

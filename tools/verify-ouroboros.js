#!/usr/bin/env node
/* Verify every Ouroboros food-fact is grounded in real chapter text:
...
const bank=JSON.parse(fs.readFileSync(path.join(ROOT,"docs/assets/games/data/ouroboros.json"),"utf8"));
let fails=0,ok=0;
...
console.log("Ouroboros facts: "+bank.facts.length+" | verified: "+ok+" | failures: "+fails);
if(fails){process.exit(1);}
console.log("VERIFY OK — every food-fact is grounded in real chapter text.");

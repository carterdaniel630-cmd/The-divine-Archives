#!/usr/bin/env node
/* Verify every Antithesis (Pong) fact is grounded in real chapter text:
...
const bank=JSON.parse(fs.readFileSync(path.join(ROOT,"docs/assets/games/data/pong.json"),"utf8"));
let fails=0,ok=0;
...
console.log("Antithesis (Pong) facts: "+bank.facts.length+" | verified: "+ok+" | failures: "+fails);
if(fails){process.exit(1);}
console.log("VERIFY OK — every contest-fact is grounded in real chapter text.");

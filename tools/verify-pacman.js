#!/usr/bin/env node
/* Verify every The Labyrinth (Pac-Man) fact is grounded in real chapter text:
...
const bank=JSON.parse(fs.readFileSync(path.join(ROOT,"docs/assets/games/data/pacman.json"),"utf8"));
let fails=0,ok=0;
...
console.log("The Labyrinth (Pac-Man) facts: "+bank.facts.length+" | verified: "+ok+" | failures: "+fails);
if(fails){process.exit(1);}
console.log("VERIFY OK — every passage-fact is grounded in real chapter text.");

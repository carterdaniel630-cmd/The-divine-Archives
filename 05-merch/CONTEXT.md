...
- No publish / list / live push. No branch created for this stage (working on the current
  branch per instruction).
- No domain/DNS change.

## Next
Carter: send the real product list and decisions on the `FLAGS.md` items. Then this stage
swaps proposed products to match, produces/reviews art, and only then can be flagged
`READY FOR REVIEW`.
